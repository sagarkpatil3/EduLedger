...
import { Box, TextField, Button, Typography, Alert, Snackbar, MenuItem } from "@mui/material";
...
export default function Register() {
  ...
  const validateForm = () => {
    ...
    if (!["student", "professor", "verifier"].includes(form.role)) return "Invalid role selected.";
    return null;
  };
